...
msg-referral-reward =
    ...
    { $reward_strategy_type ->
        ...
        [PERCENTAGE] Введите процент от { $reward_type ->
...
msg-subscription-confirm =
    ...
    { $purchase_type ->
    [RENEW] <i>⚠️ Вы продлеваете текущую подписку на указанный срок.</i>
    [CHANGE] <i>⚠️ Текущая подписка будет заменена выбранной без пересчёта оставшегося срока.</i>
    *[OTHER] { empty }
    }

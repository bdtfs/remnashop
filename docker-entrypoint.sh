...
ASSETS_CONTAINER_PATH="/opt/compono-shop/assets"
ASSETS_DEFAULT_PATH="/opt/compono-shop/assets.default"
...
if [ "$UVICORN_RELOAD_ENABLED" = "true" ]; then
    ...
    UVICORN_RELOAD_ARGS="--reload --reload-dir /opt/compono-shop/src --reload-dir /opt/compono-shop/assets --reload-include *.ftl"
else
